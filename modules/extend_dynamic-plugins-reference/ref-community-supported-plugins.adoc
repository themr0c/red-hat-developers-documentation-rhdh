...
[role="_abstract"]
{company-name} provides community support for the following 54 dynamic plugins in `ghcr.io`.
...
|*ACR*
|1.26.0|`oci://ghcr.io/redhat-developer/rhdh-plugin-export-overlays/backstage-community-plugin-acr:<tag>`
...
|1.25.1|`oci://ghcr.io/redhat-developer/rhdh-plugin-export-overlays/backstage-community-plugin-nexus-repository-manager:<tag>`
...
|*Tekton*
|3.40.1|`oci://ghcr.io/redhat-developer/rhdh-plugin-export-overlays/backstage-community-plugin-tekton:<tag>`
