...
[role="_abstract"]
You can enable authentication with PingFederate to allow users to sign in to {product-short} using their PingFederate credentials.
...
* You have a PingFederate instance with OIDC capability.
+
[TIP]
====
...
.Procedure
. Register your {product-short} application in PingFederate:
